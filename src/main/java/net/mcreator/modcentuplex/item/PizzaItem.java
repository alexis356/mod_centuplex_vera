...
public class PizzaItem extends ModCentuplexModElements.ModElement {
	@ObjectHolder("mod_centuplex:pizza")
	public static final Item block = null;
	public PizzaItem(ModCentuplexModElements instance) {
		super(instance, 33);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("fatta cu core"));
		}
	}
}
