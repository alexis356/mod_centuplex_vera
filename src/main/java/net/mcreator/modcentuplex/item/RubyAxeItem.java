...
public class RubyAxeItem extends ModCentuplexModElements.ModElement {
	@ObjectHolder("mod_centuplex:ruby_axe")
	public static final Item block = null;
	public RubyAxeItem(ModCentuplexModElements instance) {
		super(instance, 8);
	}
