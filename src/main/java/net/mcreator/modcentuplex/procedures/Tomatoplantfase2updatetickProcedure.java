...
import net.mcreator.modcentuplex.block.Tomatoplantfase3Block;
import net.mcreator.modcentuplex.ModCentuplexModElements;

import java.util.Map;

@ModCentuplexModElements.ModElement.Tag
public class Tomatoplantfase2updatetickProcedure extends ModCentuplexModElements.ModElement {
	public Tomatoplantfase2updatetickProcedure(ModCentuplexModElements instance) {
		super(instance, 46);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure Tomatoplantfase2updatetick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure Tomatoplantfase2updatetick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure Tomatoplantfase2updatetick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure Tomatoplantfase2updatetick!");
			return;
		}
		...
		if (((((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.GRASS_BLOCK.getDefaultState().getBlock())
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Tomatoplantfase3Block.block.getDefaultState(), 3);
			}
		} else {
