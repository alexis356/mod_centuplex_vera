...
public class InfernosaplingupdatetickProcedure extends ModCentuplexModElements.ModElement {
	public InfernosaplingupdatetickProcedure(ModCentuplexModElements instance) {
		super(instance, 50);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure Infernosaplingupdatetick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure Infernosaplingupdatetick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure Infernosaplingupdatetick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure Infernosaplingupdatetick!");
			return;
		}
			...
			if (((new Object() {
				...
				if (!world.getWorld().isRemote) {
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("mod_centuplex", "albero_inferno1"));
					if (template != null) {
