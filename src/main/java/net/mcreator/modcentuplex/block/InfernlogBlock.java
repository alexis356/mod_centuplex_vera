...
public class InfernlogBlock extends ModCentuplexModElements.ModElement {
	@ObjectHolder("mod_centuplex:infernlog")
	public static final Block block = null;
	public InfernlogBlock(ModCentuplexModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 5f).lightValue(0).harvestLevel(1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("infernlog");
		}
