...
import net.mcreator.modcentuplex.item.RubyItem;
...
public class RubyOreBlock extends ModCentuplexModElements.ModElement {
	@ObjectHolder("mod_centuplex:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(ModCentuplexModElements instance) {
		super(instance, 2);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 1, 1, 88))));
		}
	}
}
