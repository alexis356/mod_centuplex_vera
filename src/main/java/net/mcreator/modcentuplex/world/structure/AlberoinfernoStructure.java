...
package net.mcreator.modcentuplex.world.structure;
...
public class AlberoinfernoStructure extends ModCentuplexModElements.ModElement {
	public AlberoinfernoStructure(ModCentuplexModElements instance) {
		super(instance, 52);
	}
